    ...
    $.extend(FixToContainer.prototype, {
        ...
        _onscroll: function _onscroll() {
            ...
            if (this.options.mindBottomPadding !== false) {
                this._parentBottom -= (computedStyle.getFloat(this.parent, 'paddingBottom') || 0);
            }
            ...
            if (!this.fixed && this._shouldFix()) {
				...
				_temporaryOffset: function() {
					if($(this.options.headroomDiv).is(".headroom--pinned.sticky")) {
						return $(this.options.headroomDiv).height();
					} else {
						return 0;
					}
				},
