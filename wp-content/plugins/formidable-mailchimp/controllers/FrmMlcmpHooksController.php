...
class FrmMlcmpHooksController {
	...
	public static function load_admin_hooks() {
		...
		register_activation_hook( FrmMlcmpAppHelper::plugin_folder() . '/formidable-mailchimp.php', 'FrmMlcmpAppController::install' );

		// Global settings
		add_action( 'frm_add_settings_section', 'FrmMlcmpSettingsController::add_settings_section' );

		// Ajax functions
		add_action( 'wp_ajax_frmmlcmp_install', 'FrmMlcmpAppController::install' );
