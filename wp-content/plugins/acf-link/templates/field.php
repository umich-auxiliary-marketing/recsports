<div
  class="acf-input-wrap acf-file-uploader acf-link<?php echo array_filter($values) ? ' has-value': '' ?>"
  data-show-fields='<?php echo json_encode($field['show_fields']) ?>'>
    ...
    <div class="view show-if-value file-wrap acf-soh">
			<div class="file-icon">
			<img data-name="icon" src="<?= get_site_url(); ?>/wp-includes/images/media/default.png" alt="">
		</div>
        <div class="link-info file-info">
            <p style="margin: 0;">
                ...
                <a data-name="display-url"
                  ...
                  target="_blank"><?php echo esc_html($values['url']) ?></a><br>
				...
				<ul class="acf-hl acf-soh-target acf-soh-target-link">
